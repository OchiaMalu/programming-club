...
import com.ochiamalu.subject.infra.basic.entity.EsSubjectFields;
import com.ochiamalu.subject.infra.basic.entity.SubjectInfoEs;
import com.ochiamalu.subject.infra.basic.es.EsIndexInfo;
import com.ochiamalu.subject.infra.basic.es.EsRestClient;
import com.ochiamalu.subject.infra.basic.es.EsSearchRequest;
import com.ochiamalu.subject.infra.basic.es.EsSourceData;
...
public class SubjectEsServiceImpl implements SubjectEsService {
    @Override
    public boolean addSubject(SubjectInfoEs subjectInfoEs) {
    ...
    @Override
    public PageResult<SubjectInfoEs> searchSubjects(SubjectInfoEs req) {
    ...
    private EsSearchRequest createSearchListQuery(SubjectInfoEs req) {
        ...
        esSearchRequest.setBoolQueryBuilder(bq);
    ...
    private EsIndexInfo getEsIndexInfo() {
        ...
        esIndexInfo.setClusterName("c95501590c59");
    ...
    private Map<String, Object> convert2EsSourceData(SubjectInfoEs subjectInfoEs) {
        ...
        data.put(EsSubjectFields.SUBJECT_ID, subjectInfoEs.getSubjectType());
